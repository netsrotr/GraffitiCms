...
This brand is currently under development. This is NOT a stable/tested branch.
...
1. Unzip the "extra assemblies" lib.zip file and place the dll files in the \Branches\v1.4\src\Lib folder.

2. Open the \Branches\v1.4\src\Graffiti.sln solution file with Visual studio 2008.
...
6. Setup the database using the instructions in the \Branches\v1.4\data\read_me.txt file.
